...
import com.reference.implementation.messages.presentation.screens.message.MessageDetailUiState
...
@Composable
fun MonitorMessageDetailScreen(
                ...
                actions = {
                    when (uiState) {
                        is MessageDetailUiState.Success -> {
                            ...
                            // Delete Action
                            IconButton(onClick = showDeleteDialog, enabled = false) {
                                Icon(
...
@Composable
fun MonitorMessageContentPreview() {
        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    Text(
                        text = "The Administrator can only monitor another user\u0027s messages.",
